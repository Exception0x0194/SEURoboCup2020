...
*   本教程在匆忙中完成，必然有诸多疏漏。如有意见或建议，可以通过[issue](https://gitee.com/robocup/SEURoboCup2020/issues)或者QQ群向我们提供反馈。
*   本教程有许多操作可以通过网上教程知悉，此处暂且不表，一律以“略”代替。详细图文教程尚在制作，预计会同赛题代码同时发布，稍安勿躁～
<!--Note:略的地方就是要讲的地方。赛题在昨天晚上已经发布了。-->

⚠ 本教程基于 16.04 安装教程，故图片等可能与实际安装有巨大出入，请以实物为准。
...
2. [下载镜像](https://mirrors.huaweicloud.com/repository/ubuntu-releases/20.04.1/ubuntu-20.04.1-desktop-amd64.iso)
...
6. 启动后，您需要在您之前腾出的不小于40GB的磁盘空间上安装 *Ubuntu 20.04。此处可以参见[Linux公社教程](https://www.linuxidc.com/Linux/2016-04/130520.htm)。
